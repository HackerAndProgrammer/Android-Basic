...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun initUI() {
        binding.rsVolume.addOnChangeListener { _, value, _ -> // When the rangeSlider is changed, the value is returned
            ...
            CoroutineScope(Dispatchers.IO).launch {
                // Save the volume entered by the user (when the rangeSlider is changed)
    ...
    // This function will get ALL the settings, not just Checkbox, or RangeSlider, literally, ALL of them
